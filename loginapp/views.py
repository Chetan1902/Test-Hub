...
from loginapp.models import Admin, Question, Result, Users
from loginapp.serilizers import QuestionSerilizer, ResultSerilizers, UsersSerilizers
...
@api_view(['GET','POST'])
def giveStudentInfo(request):
     return Response({'rno':1,'name':"xyz"})
